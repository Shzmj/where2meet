...
import centroidMarkerIcon from "./centroid.jpg"
import another_userMarkerIcon from "./another_user.jpeg"
...
function Map() {
	...
	>
		<MarkerF position={blueMountains} icon={another_userMarkerIcon} />
		<MarkerF position={northEastHarbour} icon={centroidMarkerIcon} />
		<MarkerF position={coogeeBeach} icon={centroidMarkerIcon} />
	</GoogleMap>
}